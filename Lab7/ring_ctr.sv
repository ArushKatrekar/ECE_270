...
module top (
  ...
  hc74_set ff0 (.c  (pb[0]),.sn (pb[16]),.d  (right[3]),.q  (right[0]),.qn ());
  hc74_reset ff1 (.c  (pb[0]),.rn (pb[16]),.d  (right[0]),.q  (right[1]),.qn ());
  hc74_reset ff2 (.c  (pb[0]),.rn (pb[16]),.d  (right[1]),.q  (right[2]),.qn ());
  hc74_reset ff3 (.c  (pb[0]),.rn (pb[16]),.d  (right[2]),.q  (right[3]),.qn ());
endmodule
